...
import { InspirationSourcesPage } from './pages/InspirationSourcesPage';
    ...
    <BrowserRouter>
      <div className="min-h-screen flex">
        ...
        <nav className="w-64 bg-white border-r border-gray-200 p-4 flex flex-col gap-2">
          ...
          <Link to="/setup" className="px-3 py-2 rounded-lg hover:bg-gray-100 text-gray-700 font-medium">
            ⚙️ Platform Setup
          </Link>
          <Link to="/accounts" className="px-3 py-2 rounded-lg hover:bg-gray-100 text-gray-700 font-medium">
            🔗 Accounts
          </Link>
          <Link to="/inspiration" className="px-3 py-2 rounded-lg hover:bg-gray-100 text-gray-700 font-medium">
            💡 Inspiration
          </Link>
          <Link to="/inspiration/sources" className="px-3 py-2 rounded-lg hover:bg-gray-100 text-gray-700 font-medium">
            📡 Sources
          </Link>
        ...
        <main className="flex-1 p-8">
          <Routes>
            ...
            <Route path="/inspiration/sources" element={<InspirationSourcesPage />} />
